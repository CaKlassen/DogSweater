...
public class InfoPopup extends Dialog {
    ...
    Context context;
    public InfoPopup(final Context context,String imageurl, final String nextScreen, String Title) {
        super(context);
    ...
    //Set popup window
        ...
        int resID = getContext().getResources().getIdentifier(imageurl,  "drawable", "group8.comp3900.year2014.com.bcit.dogsweater");
