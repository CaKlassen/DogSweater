 ...
 * The XML parsing code comes from https://github.com/darvds/RibbonMenu
 *
 * Used due to the app being activity based and not fragments
 * The default android menu would be used instead if fragmented.
 *************************************************************************************/
